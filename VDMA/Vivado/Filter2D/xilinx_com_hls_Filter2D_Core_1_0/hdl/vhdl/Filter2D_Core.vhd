...
architecture behav of Filter2D_Core is 
    ...
    signal Block_Mat_exit45_pro_U0_p_src_rows_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit45_pro_U0_p_src_rows_V_out_write : STD_LOGIC;
    signal Block_Mat_exit45_pro_U0_p_src_cols_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit45_pro_U0_p_src_cols_V_out_write : STD_LOGIC;
    signal Block_Mat_exit45_pro_U0_p_dst_rows_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit45_pro_U0_p_dst_rows_V_out_write : STD_LOGIC;
    signal Block_Mat_exit45_pro_U0_p_dst_cols_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit45_pro_U0_p_dst_cols_V_out_write : STD_LOGIC;
    signal Block_Mat_exit45_pro_U0_src_rows_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit45_pro_U0_src_rows_out_write : STD_LOGIC;
    signal Block_Mat_exit45_pro_U0_src_cols_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit45_pro_U0_src_cols_out_write : STD_LOGIC;
    signal Block_Mat_exit45_pro_U0_sigma_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit45_pro_U0_sigma_out_write : STD_LOGIC;
    ...
    signal GaussianBlur_U0_src_val_address0 : STD_LOGIC_VECTOR (17 downto 0);
    ...
    signal GaussianBlur_U0_dst_val_address0 : STD_LOGIC_VECTOR (17 downto 0);
    ...
    signal Array2D2Mat_U0_mat_rows_V_read : STD_LOGIC;
    signal Array2D2Mat_U0_mat_cols_V_read : STD_LOGIC;
    ...
    signal Array2D2Mat_U0_mat_rows_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Array2D2Mat_U0_mat_rows_V_out_write : STD_LOGIC;
    signal Array2D2Mat_U0_mat_cols_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Array2D2Mat_U0_mat_cols_V_out_write : STD_LOGIC;
    ...
    signal p_dst_rows_V_c19_full_n : STD_LOGIC;
    signal p_dst_rows_V_c19_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal p_dst_rows_V_c19_empty_n : STD_LOGIC;
    signal p_dst_cols_V_c20_full_n : STD_LOGIC;
    signal p_dst_cols_V_c20_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal p_dst_cols_V_c20_empty_n : STD_LOGIC;
    ...
    component Filter2D_Core_srcmb6 IS
    generic (
        DataWidth : INTEGER;
    ...
    component start_for_Mat2Arrocq IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    src_val_U : component Filter2D_Core_srcmb6
    generic map (
        DataWidth => 8,
        AddressRange => 250000,
        AddressWidth => 18)
    ...
    dst_val_U : component Filter2D_Core_srcmb6
    generic map (
        DataWidth => 8,
        AddressRange => 250000,
        AddressWidth => 18)
    ...
    p_dst_rows_V_c_U : component fifo_w32_d5_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    p_dst_cols_V_c_U : component fifo_w32_d5_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    src_rows_c_U : component fifo_w32_d4_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    src_cols_c_U : component fifo_w32_d4_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    p_dst_rows_V_c19_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    p_dst_cols_V_c20_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Mat2Arrocq_U : component start_for_Mat2Arrocq
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ap_done <= Mat2AXIvideo_U0_ap_done;
    ap_idle <= ((dst_val_t_empty_n xor ap_const_logic_1) and (src_val_t_empty_n xor ap_const_logic_1) and Mat2Array2D_U0_ap_idle and Mat2AXIvideo_U0_ap_idle and GaussianBlur_U0_ap_idle and Block_Mat_exit45_pro_U0_ap_idle and Array2D2Mat_U0_ap_idle and AXIvideo2Mat_U0_ap_idle);
