...
HD_PWD='F:/FPGA/project/Vivado/Hough_Circle/image_process.runs/design_1_BRAM_TRCL1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_BRAM_TRCL1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_BRAM_TRCL1_0.tcl
