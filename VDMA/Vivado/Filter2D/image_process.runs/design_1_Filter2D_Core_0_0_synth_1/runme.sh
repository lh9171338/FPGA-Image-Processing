...
HD_PWD='F:/FPGA/project/Vivado/Filter2D/image_process.runs/design_1_Filter2D_Core_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Filter2D_Core_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Filter2D_Core_0_0.tcl
