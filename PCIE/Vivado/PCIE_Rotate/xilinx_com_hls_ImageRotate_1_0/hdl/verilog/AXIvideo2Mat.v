...
wire   [0:0] exitcond4_i_fu_297_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((exitcond4_i_fu_297_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((exitcond_i_fu_308_p2 == 1'd1) & (1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((exitcond4_i_fu_297_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((eol_2_i_reg_243 == 1'd0) & (1'b0 == ap_block_pp2_stage0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0)) | ((brmerge_i_reg_381 == 1'd0) & (exitcond_i_reg_372 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)))) begin
        S_AXIS_TDATA_blk_n = AXI_video_strm_V_data_V_0_state[1'd0];
    end else begin
...
always @ (*) begin
    if (((exitcond4_i_fu_297_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
assign AXI_video_strm_V_data_V_0_vld_in = S_AXIS_TVALID;

assign AXI_video_strm_V_data_V_0_vld_out = AXI_video_strm_V_data_V_0_state[1'd0];

assign AXI_video_strm_V_dest_V_0_vld_in = S_AXIS_TVALID;
...
assign AXI_video_strm_V_last_V_0_vld_in = S_AXIS_TVALID;
...
assign AXI_video_strm_V_user_V_0_vld_in = S_AXIS_TVALID;

assign AXI_video_strm_V_user_V_0_vld_out = AXI_video_strm_V_user_V_0_state[1'd0];

assign S_AXIS_TREADY = AXI_video_strm_V_dest_V_0_state[1'd1];
...
assign exitcond4_i_fu_297_p2 = ((t_V_reg_161 == rows_V_reg_333) ? 1'b1 : 1'b0);

assign exitcond_i_fu_308_p2 = ((t_V_4_reg_172 == cols_V_reg_338) ? 1'b1 : 1'b0);
...
assign j_V_fu_313_p2 = (t_V_4_reg_172 + 32'd1);
