...
reg   [16:0] t_V_3_reg_151;
reg   [17:0] img_rows_V_read_reg_224;
reg    ap_block_state1;
reg   [16:0] img_cols_V_read_reg_229;
wire   [17:0] r_V_fu_166_p2;
reg   [17:0] r_V_reg_234;
wire   [0:0] exitcond3_i_fu_177_p2;
wire    ap_CS_fsm_state2;
reg    ap_block_state2;
wire   [17:0] i_V_fu_182_p2;
reg   [17:0] i_V_reg_243;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_condition_pp0_exit_iter0_state3) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if ((~((1'b0 == AXI_video_strm_V_data_V_1_ack_in) | (1'b0 == AXI_video_strm_V_dest_V_1_ack_in) | (1'b0 == AXI_video_strm_V_id_V_1_ack_in) | (1'b0 == AXI_video_strm_V_last_V_1_ack_in) | (1'b0 == AXI_video_strm_V_user_V_1_ack_in) | (1'b0 == AXI_video_strm_V_strb_V_1_ack_in) | (1'b0 == AXI_video_strm_V_keep_V_1_ack_in)) & (exitcond3_i_fu_177_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
assign axi_last_V_fu_203_p2 = ((t_V_3_cast_fu_188_p1 == r_V_reg_234) ? 1'b1 : 1'b0);

assign cols_V_cast_fu_162_p1 = img_cols_V_dout;

assign exitcond3_i_fu_177_p2 = ((t_V_reg_140 == img_rows_V_read_reg_224) ? 1'b1 : 1'b0);

assign exitcond_i_fu_192_p2 = ((t_V_3_reg_151 == img_cols_V_read_reg_229) ? 1'b1 : 1'b0);

assign i_V_fu_182_p2 = (t_V_reg_140 + 18'd1);

assign j_V_fu_197_p2 = (t_V_3_reg_151 + 17'd1);

assign r_V_fu_166_p2 = ($signed(cols_V_cast_fu_162_p1) + $signed(18'd262143));

assign t_V_3_cast_fu_188_p1 = t_V_3_reg_151;
