...
entity sin_or_cos_float_dEe_rom is 
    generic(
             DWIDTH     : integer := 100; 
             AWIDTH     : integer := 4; 
             MEM_SIZE    : integer := 13
...
architecture rtl of sin_or_cos_float_dEe_rom is 
...
entity sin_or_cos_float_dEe is
    generic (
...
architecture arch of sin_or_cos_float_dEe is
    component sin_or_cos_float_dEe_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    sin_or_cos_float_dEe_rom_U :  component sin_or_cos_float_dEe_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
