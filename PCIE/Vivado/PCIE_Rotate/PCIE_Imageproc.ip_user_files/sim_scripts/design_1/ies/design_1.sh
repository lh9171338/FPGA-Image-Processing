...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../bd/design_1/ipshared/d43a" \
       +incdir+"$ref_dir/../../../../PCIE_Imageproc.srcs/sources_1/bd/design_1/ipshared/b65a" \
       +incdir+"../../../../PCIE_Imageproc.srcs/sources_1/bd/design_1/ipshared/d43a" \
       +incdir+"../../../../PCIE_Imageproc.srcs/sources_1/bd/design_1/ipshared/b65a"
}
