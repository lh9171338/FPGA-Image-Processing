...
HD_PWD='F:/FPGA/project/Vivado/PCIE_Rotate/PCIE_Imageproc.runs/design_1_Riffa_Axis_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Riffa_Axis_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Riffa_Axis_0_0.tcl
