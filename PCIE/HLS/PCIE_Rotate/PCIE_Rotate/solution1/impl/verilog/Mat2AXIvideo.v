...
reg   [0:0] exitcond_i_reg_238;
reg    M_AXIS_TDATA_blk_n;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] exitcond_i_reg_238_pp0_iter1_reg;
reg   [31:0] t_V_1_reg_141;
reg   [31:0] rows_V_reg_214;
reg    ap_block_state1;
reg   [31:0] cols_V_reg_219;
wire   [32:0] r_V_fu_156_p2;
reg   [32:0] r_V_reg_224;
wire   [0:0] exitcond2_i_fu_167_p2;
wire    ap_CS_fsm_state2;
reg    ap_block_state2;
wire   [31:0] i_V_fu_172_p2;
reg   [31:0] i_V_reg_233;
wire   [0:0] exitcond_i_fu_178_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_condition_pp0_exit_iter0_state3) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if ((~((1'b0 == AXI_video_strm_V_data_V_1_ack_in) | (1'b0 == AXI_video_strm_V_dest_V_1_ack_in) | (1'b0 == AXI_video_strm_V_id_V_1_ack_in) | (1'b0 == AXI_video_strm_V_last_V_1_ack_in) | (1'b0 == AXI_video_strm_V_user_V_1_ack_in) | (1'b0 == AXI_video_strm_V_strb_V_1_ack_in) | (1'b0 == AXI_video_strm_V_keep_V_1_ack_in)) & (exitcond2_i_fu_167_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_178_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_reg_238 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_178_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((((exitcond_i_reg_238_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((exitcond_i_reg_238 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
        M_AXIS_TDATA_blk_n = AXI_video_strm_V_data_V_1_state[1'd1];
    end else begin
...
always @ (*) begin
    if ((exitcond_i_fu_178_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((exitcond_i_reg_238 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((exitcond_i_fu_178_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((exitcond_i_fu_178_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
...
assign AXI_video_strm_V_data_V_1_ack_out = M_AXIS_TREADY;
...
assign AXI_video_strm_V_dest_V_1_ack_out = M_AXIS_TREADY;
...
assign AXI_video_strm_V_id_V_1_ack_out = M_AXIS_TREADY;
...
assign AXI_video_strm_V_keep_V_1_ack_out = M_AXIS_TREADY;
...
assign AXI_video_strm_V_last_V_1_ack_out = M_AXIS_TREADY;
...
assign AXI_video_strm_V_strb_V_1_ack_out = M_AXIS_TREADY;
...
assign AXI_video_strm_V_user_V_1_ack_out = M_AXIS_TREADY;
...
assign M_AXIS_TDATA = AXI_video_strm_V_data_V_1_data_out;

assign M_AXIS_TDEST = AXI_video_strm_V_dest_V_1_data_out;

assign M_AXIS_TID = AXI_video_strm_V_id_V_1_data_out;

assign M_AXIS_TKEEP = AXI_video_strm_V_keep_V_1_data_out;

assign M_AXIS_TLAST = AXI_video_strm_V_last_V_1_data_out;

assign M_AXIS_TSTRB = AXI_video_strm_V_strb_V_1_data_out;

assign M_AXIS_TUSER = AXI_video_strm_V_user_V_1_data_out;

assign M_AXIS_TVALID = AXI_video_strm_V_dest_V_1_state[1'd0];
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((exitcond_i_reg_238 == 1'd0) & (img_data_stream_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state5_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state4_io) | ((exitcond_i_reg_238 == 1'd0) & (img_data_stream_V_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state5_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state4_io) | ((exitcond_i_reg_238 == 1'd0) & (img_data_stream_V_empty_n == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state4_io = ((exitcond_i_reg_238 == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in));
end

always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = ((exitcond_i_reg_238 == 1'd0) & (img_data_stream_V_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state5_io = ((exitcond_i_reg_238_pp0_iter1_reg == 1'd0) & (1'b0 == AXI_video_strm_V_data_V_1_ack_in));
end
...
assign axi_last_V_fu_193_p2 = ((tmp_cast_i_fu_189_p1 == r_V_reg_224) ? 1'b1 : 1'b0);

assign exitcond2_i_fu_167_p2 = ((t_V_reg_130 == rows_V_reg_214) ? 1'b1 : 1'b0);

assign exitcond_i_fu_178_p2 = ((t_V_1_reg_141 == cols_V_reg_219) ? 1'b1 : 1'b0);

assign i_V_fu_172_p2 = (t_V_reg_130 + 32'd1);

assign j_V_fu_183_p2 = (t_V_1_reg_141 + 32'd1);

assign lhs_V_cast_i_fu_152_p1 = img_cols_V_dout;

assign r_V_fu_156_p2 = ($signed(lhs_V_cast_i_fu_152_p1) + $signed(33'd8589934591));

assign tmp_cast_i_fu_189_p1 = t_V_1_reg_141;
