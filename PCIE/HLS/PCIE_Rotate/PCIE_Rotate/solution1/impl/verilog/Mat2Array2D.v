...
wire   [30:0] i_2_fu_181_p2;
reg   [30:0] i_2_reg_535;
wire   [0:0] tmp_2_fu_187_p2;
reg   [0:0] tmp_2_reg_540;
wire   [17:0] tmp_34_cast_fu_203_p3;
reg   [17:0] tmp_34_cast_reg_544;
...
wire   [17:0] tmp_16_fu_252_p2;
reg   [17:0] tmp_16_reg_558;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state3;
reg   [30:0] i_reg_128;
wire    ap_CS_fsm_state5;
wire  signed [63:0] tmp_35_cast_fu_257_p1;
...
wire   [9:0] tmp_63_fu_193_p1;
wire   [9:0] tmp_64_fu_197_p2;
wire   [31:0] j_cast_fu_233_p1;
wire   [17:0] tmp_67_fu_248_p1;
wire   [29:0] tmp_66_fu_264_p4;
wire   [1:0] tmp_68_fu_289_p1;
wire   [1:0] tmp_69_fu_307_p1;
wire   [4:0] tmp_70_fu_311_p3;
wire   [31:0] tmp_71_fu_319_p1;
wire   [31:0] tmp_72_fu_323_p2;
wire   [31:0] p_Val2_s_fu_293_p6;
wire   [31:0] tmp_73_fu_329_p2;
wire   [31:0] tmp_75_fu_341_p1;
wire   [31:0] tmp_74_fu_335_p2;
wire   [31:0] tmp_76_fu_345_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_fu_274_p2 == 1'd1) & (tmp_2_reg_540 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_5_fu_237_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_5_fu_237_p2 == 1'd1) & (tmp_2_reg_540 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_s_fu_176_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        tmp_34_cast_reg_544[17 : 8] <= tmp_34_cast_fu_203_p3[17 : 8];
    end
end

always @ (*) begin
    if ((tmp_5_fu_237_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (tmp_2_reg_540 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        arr_val_we0 = 1'b1;
    end else begin
        arr_val_we0 = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if (~((tmp_5_fu_237_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((tmp_5_fu_237_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign arr_val_address0 = tmp_35_cast_fu_257_p1;

assign arr_val_d0 = mat_data_stream_V_dout;

assign i_2_fu_181_p2 = (i_reg_128 + 31'd1);

assign i_cast_fu_172_p1 = i_reg_128;

assign icmp_fu_274_p2 = (($signed(tmp_66_fu_264_p4) < $signed(30'd1)) ? 1'b1 : 1'b0);

assign idx_1_fu_419_p2 = (idx_fu_76 + 32'd1);

assign idx_2_fu_431_p3 = ((tmp_9_fu_413_p2[0:0] === 1'b1) ? idx_1_fu_419_p2 : idx_fu_76);
...
assign offset_2_fu_439_p3 = ((tmp_9_fu_413_p2[0:0] === 1'b1) ? 32'd0 : offset_1_fu_425_p2);

assign p_Result_s_fu_351_p2 = (tmp_76_fu_345_p2 | tmp_74_fu_335_p2);

assign rows_fu_156_p2 = ($signed(mat_rows_V_read) + $signed(32'd4294967295));

assign tmp_16_fu_252_p2 = (tmp_34_cast_reg_544 + tmp_67_fu_248_p1);

assign tmp_2_fu_187_p2 = ((i_reg_128 == 31'd0) ? 1'b1 : 1'b0);

assign tmp_34_cast_fu_203_p3 = {{tmp_64_fu_197_p2}, {8'd0}};

assign tmp_35_cast_fu_257_p1 = $signed(tmp_16_reg_558);

assign tmp_5_fu_237_p2 = (($signed(j_cast_fu_233_p1) < $signed(mat_cols_V_read)) ? 1'b1 : 1'b0);

assign tmp_63_fu_193_p1 = i_reg_128[9:0];

assign tmp_64_fu_197_p2 = ($signed(10'd1023) + $signed(tmp_63_fu_193_p1));

assign tmp_66_fu_264_p4 = {{idx_fu_76[31:2]}};

assign tmp_67_fu_248_p1 = j_reg_139[17:0];

assign tmp_68_fu_289_p1 = idx_fu_76[1:0];

assign tmp_69_fu_307_p1 = offset_fu_72[1:0];

assign tmp_70_fu_311_p3 = {{tmp_69_fu_307_p1}, {3'd0}};

assign tmp_71_fu_319_p1 = tmp_70_fu_311_p3;

assign tmp_72_fu_323_p2 = 32'd255 << tmp_71_fu_319_p1;

assign tmp_73_fu_329_p2 = (tmp_72_fu_323_p2 ^ 32'd4294967295);

assign tmp_74_fu_335_p2 = (tmp_73_fu_329_p2 & p_Val2_s_fu_293_p6);

assign tmp_75_fu_341_p1 = mat_data_stream_V_dout;

assign tmp_76_fu_345_p2 = tmp_75_fu_341_p1 << tmp_71_fu_319_p1;

assign tmp_9_fu_413_p2 = (($signed(offset_fu_72) > $signed(32'd2)) ? 1'b1 : 1'b0);

assign tmp_s_fu_176_p2 = (($signed(i_cast_fu_172_p1) < $signed(mat_rows_V_read)) ? 1'b1 : 1'b0);

always @ (posedge ap_clk) begin
    tmp_34_cast_reg_544[7:0] <= 8'b00000000;
end
