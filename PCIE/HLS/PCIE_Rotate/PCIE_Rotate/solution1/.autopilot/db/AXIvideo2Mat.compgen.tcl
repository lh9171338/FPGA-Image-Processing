...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { S_AXIS_TVALID { I 1 bit } S_AXIS_TREADY { O 1 bit } S_AXIS_TDEST { I 1 vector } } \
} "
} else {
