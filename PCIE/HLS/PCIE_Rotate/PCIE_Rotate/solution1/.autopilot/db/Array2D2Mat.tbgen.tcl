...
set C_modelArgList {
	...
	{ param_val_0_V_read int 32 regular  }
	{ param_val_1_V_read int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "arr_val", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "param_val_0_V_read", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "param_val_1_V_read", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ param_val_0_V_read sc_in sc_lv 32 signal 3 } 
	{ param_val_1_V_read sc_in sc_lv 32 signal 4 } 
	{ mat_data_stream_V_din sc_out sc_lv 8 signal 5 } 
	{ mat_data_stream_V_full_n sc_in sc_logic 1 signal 5 } 
	{ mat_data_stream_V_write sc_out sc_logic 1 signal 5 } 
	{ mat_rows_V_din sc_out sc_lv 32 signal 6 } 
	{ mat_rows_V_full_n sc_in sc_logic 1 signal 6 } 
	{ mat_rows_V_write sc_out sc_logic 1 signal 6 } 
	{ mat_cols_V_din sc_out sc_lv 32 signal 7 } 
	{ mat_cols_V_full_n sc_in sc_logic 1 signal 7 } 
	{ mat_cols_V_write sc_out sc_logic 1 signal 7 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "param_val_0_V_read", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "param_val_0_V_read", "role": "default" }} , 
 	{ "name": "param_val_1_V_read", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "param_val_1_V_read", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "param_val_0_V_read", "Type" : "None", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0"},
			{"Name" : "param_val_1_V_read", "Type" : "None", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "66564"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "66564"}
]}
...
set Spec2ImplPortList { 
	...
	param_val_0_V_read { ap_none {  { param_val_0_V_read in_data 0 32 } } }
	param_val_1_V_read { ap_none {  { param_val_1_V_read in_data 0 32 } } }
