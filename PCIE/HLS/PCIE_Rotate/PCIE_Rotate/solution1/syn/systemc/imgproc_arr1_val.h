...
#ifndef _imgproc_arr1_val_H_
#define _imgproc_arr1_val_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "imgproc_arr1_val_memcore.h"

SC_MODULE(imgproc_arr1_val) {
...
protected:
    ...
    imgproc_arr1_val_memcore* imgproc_arr1_val_memcore_U;
...
public:
    ~imgproc_arr1_val();
    SC_CTOR(imgproc_arr1_val) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        imgproc_arr1_val_memcore_U = new imgproc_arr1_val_memcore("imgproc_arr1_val_memcore_U");
        imgproc_arr1_val_memcore_U->clk      ( clk );
        imgproc_arr1_val_memcore_U->reset    ( reset );
        imgproc_arr1_val_memcore_U->ce0      ( i_ce0 );
        imgproc_arr1_val_memcore_U->we0      ( i_we0 );
        imgproc_arr1_val_memcore_U->address0 ( memcore_iaddr );
        imgproc_arr1_val_memcore_U->d0       ( i_d0 );
        imgproc_arr1_val_memcore_U->q0       ( i_q0 );

        imgproc_arr1_val_memcore_U->ce1      ( t_ce0 );
        imgproc_arr1_val_memcore_U->we1      ( t_we0 );
        imgproc_arr1_val_memcore_U->address1 ( memcore_taddr );
        imgproc_arr1_val_memcore_U->d1       ( t_d0 );
        imgproc_arr1_val_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "imgproc_arr1_val.trace");
            // ports
