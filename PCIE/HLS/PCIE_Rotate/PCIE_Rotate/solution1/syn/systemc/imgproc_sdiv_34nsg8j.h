...
#ifndef __imgproc_sdiv_34nsg8j__HH__
#define __imgproc_sdiv_34nsg8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(imgproc_sdiv_34nsg8j) {
    ...
    SC_CTOR(imgproc_sdiv_34nsg8j):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
