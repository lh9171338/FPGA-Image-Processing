...
void imgproc_arr1_val::proc_tptr() {
    if (reset.read() == SC_LOGIC_1) {
        tptr.write(0);
...
void imgproc_arr1_val::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void imgproc_arr1_val::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void imgproc_arr1_val::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {
