...
#ifndef __imgproc_sitofp_32eOg__HH__
#define __imgproc_sitofp_32eOg__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(imgproc_sitofp_32eOg) {
    ...
    SC_CTOR(imgproc_sitofp_32eOg):  ACMP_sitofp_U ("ACMP_sitofp_U") {
